                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('almacenes.destroy',$almacene->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('almacenes.show',$almacene->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('almacenes.edit',$almacene->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
